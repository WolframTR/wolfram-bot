...
//Jimp ve fs'yi çağırdık resimli giriş çıkış için
Jimp = require('jimp'),
fs = require('fs'),

//Ayarlar dosyamız içinde token,sahip,sürüm olacak
const ayarlar = require('./ayarlar.json');

//Wolfram = client olarak tanıttık.Wolfram'ı client olarak tanıyacak
var Wolfram = client;

//Bot'u Wolfram olarak tanıttık.
var bot = Wolfram;
